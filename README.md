...
📝 운영 회고와 큐레이션 노트는 [**IQ Lab Blog**](https://iq-universe.github.io/iq-blog/)에 발행됩니다.
...
도메인별 자동화 도구(iq-blogger · iq-label · iq-writer · iq-painter · iq-studio · iq-curator)를 만들고, 각 도구의 첫 검증 사례를 운영합니다. **iq-blogger**는 첫 도구로, [iq-blog](https://iq-universe.github.io/iq-blog/) 블로그를 자동 생산하는 중.

📝 운영 메트릭과 시스템 회고는 [**IQ Lab Blog**](https://iq-universe.github.io/iq-blog/)에 발행됩니다.
