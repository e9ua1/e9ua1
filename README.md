...
<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/server-cog.svg?color=%23ff4d4d" width="16" align="center"/> &nbsp;<b>IQ Dev Lab</b> &nbsp;—&nbsp; 소프트웨어 개발 전 영역 본질 탐구 연구소</summary>

<br/>

> ***"Beyond the docs — into the essence of building software."***

공식 문서를 넘어 **소프트웨어 개발 전반의 본질**을 끝까지 파고드는 연구소.

**영역** &nbsp;·&nbsp; `Backend` `Frontend` `iOS` `Android` `Architecture` `Infrastructure` `Database`

**흐름** &nbsp;·&nbsp; 원리 → 트레이드오프 → 설계 → 구현 → 검증

[![IQ Dev Lab](https://img.shields.io/badge/Visit_Site-ff4d4d?style=for-the-badge&logo=gitbook&logoColor=white)](https://iq-dev-lab.github.io)
[![Organization](https://img.shields.io/badge/GitHub_Org-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/iq-dev-lab)

</details>

<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/brain-circuit.svg?color=%23a78bfa" width="16" align="center"/> &nbsp;<b>IQ AI Lab</b> &nbsp;—&nbsp; AI의 수학적 본질을 증명하는 연구소</summary>

<br/>

> ***"Prove, don't memorize — the math behind AI."***

수학적 증명으로 **AI 알고리즘의 본질**을 파고드는 연구소.

**영역** &nbsp;·&nbsp; `RL` `DL` `CV` `NLP` `LLM` `Generative` `Audio` `Math`
...
<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/bot.svg?color=%23cc785c" width="16" align="center"/> &nbsp;<b>IQ Agent Lab</b> &nbsp;—&nbsp; 에이전트 시스템·자동화 인프라 연구소</summary>

<br/>

> ***"인간이 방향을 정하고, 에이전트가 양산하고, 큐레이션이 품질을 보증한다."***

에이전트 시스템으로 **창작 영역을 자동화**하는 1인 연구소.

**도구** &nbsp;·&nbsp; `iq-blogger` `iq-label` `iq-writer` `iq-painter` `iq-studio` `iq-curator`

**현황** &nbsp;·&nbsp; 첫 도구 **iq-blogger** → [iq-blog](https://iq-universe.github.io/iq-blog/) 자동 생산 중

[![IQ Agent Lab](https://img.shields.io/badge/Visit_Site-cc785c?style=for-the-badge&logo=anthropic&logoColor=white)](https://iq-agent-lab.github.io)
[![Organization](https://img.shields.io/badge/GitHub_Org-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/iq-agent-lab)
...
> ***"Not usage, but essence — recorded as proof."***

표면적인 사용법이 아닌, **본질을 증명하는 기록**.

**역할** &nbsp;·&nbsp; **IQ Dev Lab** · **IQ AI Lab** · **IQ Agent Lab**의 탐구를 정제

**발행** &nbsp;·&nbsp; 정리(Theorem) · 증명(Proof)으로 정제해 발행하는 허브

[![IQ Lab Blog](https://img.shields.io/badge/Visit_Site-00d9ff?style=for-the-badge&logo=astro&logoColor=white)](https://iq-universe.github.io/iq-blog/)
...
세계 전통악기 × 현대 장르의 **fusion 음악 레이블**.

**악기** &nbsp;·&nbsp; `가야금` `해금` `장구` `시타르` `타블라` `우드` `코라` `디제리두`

**장르** &nbsp;·&nbsp; `boom-bap` `funky` `jazz` `ambient` `lo-fi` `experimental`

**흐름** &nbsp;·&nbsp; iq-composer 양산(30~50개) → IQ 큐레이션 → 발행
...
<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/orbit.svg?color=%2300bfa5" width="16" align="center"/> &nbsp;<b>Woowacourse 8th BE — IQ Archive</b> &nbsp;—&nbsp; 우테코 8기 백엔드 아카이브</summary>

<br/>

> ***"I Question, therefore I am."***

우아한테크코스 8기 백엔드 크루 — 끊임없는 **'질문(Question)'으로 객체 지향과 자바의 본질**을 탐구하는 기록소.

[![Woowa 8th BE IQ](https://img.shields.io/badge/Visit_Archive-00bfa5?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Woowa-8th-BE-IQ)
...
수학·AI·알고리즘의 핵심 **직관을 manim으로 시각화**하는 채널.

**목표** &nbsp;·&nbsp; 보고 나면 외운 게 아니라 당연하게 느껴지도록
...
<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/award.svg?color=%23f59e0b" width="16" align="center"/> &nbsp;<b>Baekjoon Online Judge</b></summary>
...
<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/medal.svg?color=%23f59e0b" width="16" align="center"/> &nbsp;<b>Collegiate Programming Contest</b></summary>
...
<b>SCPC 2025</b>
<br/>
<sub>Samsung Collegiate<br/>Programming Cup</sub>
<br/><br/>
<img src="https://img.shields.io/badge/🏅%20Finalist-1428A0?style=flat-square" />
<br/>
<img src="https://img.shields.io/badge/Algorithm%20Track-1a1a1a?style=flat-square" />
<br/><br/>
<a href="https://raw.githubusercontent.com/e9ua1/e9ua1/main/cpc/SCPC_2025_Poster.jpg">
  <img src="https://img.shields.io/badge/🔗%20대회%20정보%20보러가기-555555?style=flat-square" />
</a>
</td>
<td align="center" valign="top" width="50%">
<img src="https://img.shields.io/badge/AWS%20×%20Codetree-232F3E?style=for-the-badge&logo=amazonwebservices&logoColor=FF9900" />
<br/><br/>
<b>ACPC 2025</b>
<br/>
<sub>AWS × Codetree<br/>Programming Contest</sub>
<br/><br/>
<img src="https://img.shields.io/badge/🏅%20Finalist-FF9900?style=flat-square&labelColor=232F3E" />
<br/>
<img src="https://img.shields.io/badge/Algorithm-232F3E?style=flat-square" />
<br/><br/>
<a href="https://raw.githubusercontent.com/e9ua1/e9ua1/main/cpc/ACPC_2025_Poster.png">
  <img src="https://img.shields.io/badge/🔗%20대회%20정보%20보러가기-555555?style=flat-square" />
</a>
</td>
</tr>
...
<details>
<summary>&nbsp;<img src="https://api.iconify.design/lucide/badge-check.svg?color=%2300bfa5" width="16" align="center"/> &nbsp;<b>Certifications</b></summary>
...
<tbody>
<tr>
<td><img src="https://api.iconify.design/lucide/cpu.svg?color=%23ff4d4d" width="18" align="center"/> &nbsp;<b>정보처리기사</b><br/><sub>Engineer Information Processing</sub></td>
<td align="center"><code>2024.09.10</code></td>
<td align="center">—</td>
<td>한국산업인력공단</td>
</tr>
<tr>
<td><img src="https://api.iconify.design/lucide/bar-chart-3.svg?color=%2300d9ff" width="18" align="center"/> &nbsp;<b>빅데이터분석기사</b><br/><sub>Engineer Big Data Analysis</sub></td>
<td align="center"><code>2025.07.11</code></td>
<td align="center">—</td>
<td>한국데이터산업진흥원</td>
</tr>
<tr>
<td><img src="https://api.iconify.design/lucide/database.svg?color=%2300d9ff" width="18" align="center"/> &nbsp;<b>SQLD</b><br/><sub>SQL Developer</sub></td>
<td align="center"><code>2024.09.20</code></td>
<td align="center">—</td>
<td>한국데이터산업진흥원</td>
</tr>
<tr>
<td><img src="https://api.iconify.design/lucide/line-chart.svg?color=%2300d9ff" width="18" align="center"/> &nbsp;<b>ADsP</b><br/><sub>Data Analytics Semi-Professional</sub></td>
<td align="center"><code>2024.11.29</code></td>
<td align="center">—</td>
<td>한국데이터산업진흥원</td>
</tr>
<tr>
<td><img src="https://api.iconify.design/lucide/badge-check.svg?color=%23a78bfa" width="18" align="center"/> &nbsp;<b>TOPCIT</b><br/><sub>Test of Practical Competency in IT</sub></td>
<td align="center"><code>2025.05.24</code></td>
<td align="center"><img src="https://img.shields.io/badge/Lv.3-a78bfa?style=flat-square" /></td>
<td>정보통신기획평가원</td>
</tr>
<tr>
<td><img src="https://api.iconify.design/lucide/code-2.svg?color=%23a78bfa" width="18" align="center"/> &nbsp;<b>PCCP [C++]</b><br/><sub>Certified Coding Professional</sub></td>
<td align="center"><code>2025.02.21</code></td>
<td align="center"><img src="https://img.shields.io/badge/Lv.2-a78bfa?style=flat-square" /></td>
<td>프로그래머스</td>
</tr>
</tbody>
</table>
